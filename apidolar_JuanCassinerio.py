'''
Codigo para acceder a dolar historico y en tiempo real + grafico
source: https://dolarapi.com/ = https://argentinadatos.com/
Ejecutar codigo y se abrira el grafico en buscador predeterminado (google, etc)
'''
